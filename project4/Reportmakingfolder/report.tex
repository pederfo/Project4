...
This means that if we increase the temperature the probability of reaching a high energy state gets lower and lower. Because of this there is a tansition point where we go from having a lattice that is magnitized to one which is not. Note that increasing the temperature further has no effect other than minimizing the magnetization even further. 
