...
\begin{figure}
 ...
 \caption{Plot of specific heat and the magnetic susceptibility as a function of Monte Carlo cycles. In this case $L=20$, corresponding to 400 spins. And $T = 1$. The startinig state here is orderd with all spins pointing up.}
\label{C_VandChiL20}
\end{figure}
